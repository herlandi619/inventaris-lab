...
use App\Http\Controllers\Laboran\MaintenanceController;
...
Route::prefix('laboran')
    ...
    Route::get('/perawatan', [MaintenanceController::class, 'index'])->name('maintenance.index');

    Route::get('/perawatan/create', [MaintenanceController::class, 'create'])->name('maintenance.create');

    Route::post('/perawatan/store', [MaintenanceController::class, 'store'])->name('maintenance.store');

    Route::get('/perawatan/show/{id}', [MaintenanceController::class, 'show'])->name('maintenance.show');

    Route::get('/perawatan/edit/{id}', [MaintenanceController::class, 'edit'])->name('maintenance.edit');

    Route::put('/perawatan/update/{id}', [MaintenanceController::class, 'update'])->name('maintenance.update');

    Route::delete('/perawatan/delete/{id}', [MaintenanceController::class, 'destroy'])->name('maintenance.delete');
