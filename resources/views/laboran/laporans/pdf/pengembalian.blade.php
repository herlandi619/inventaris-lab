...
{{-- KOP SURAT --}}
<table class="kop-table" style="width:100%; border-collapse:collapse; margin-top:10px; padding-bottom:12px;">
    <tr>
...
{{-- JUDUL LAPORAN --}}
<div class="judul">
    <h2>Laporan Peminjaman &amp; Pengembalian Alat Laboratorium</h2>
