        ...
        <form method="GET">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="search" placeholder="Cari mahasiswa / alat"
                ...
                {{-- TANGGAL MULAI --}}
                <div>
                    <label class="text-sm font-semibold text-gray-600">Tanggal Dari</label>
                ...
                {{-- TANGGAL SELESAI --}}
                <div>
                    <label class="text-sm font-semibold text-gray-600">Tanggal Sampai</label>
            ...
            <table class="w-full text-sm text-left">
                <thead class="bg-gray-100 text-gray-700">
                    <tr>
                        ...
                        <th class="px-5 py-3 font-semibold">Tgl Dikembalikan</th>
                        ...
                        <tr class="border-t hover:bg-gray-50">
                            ...
                            <td class="px-5 py-3">
                                <span class="px-2 py-1 rounded text-xs
                                    @if($p->peminjaman->status == 'dipinjam') bg-yellow-100 text-yellow-700
                                    @elseif($p->peminjaman->status == 'dikembalikan') bg-green-100 text-green-700
