...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .fab-qr svg { width: 26px; height: 26px; color: #fff; }
  @media (min-width: 1024px) { .fab-qr { display: none; } }
</style>
</head>
<body>
  ...
  <div class="sb-footer">
    <a href="{{ route('profile.edit') }}" class="sb-user">
      ...
      <div>
        ...
        <div class="sb-urole">Mahasiswa</div>
      </div>
    </a>
  </div>
...
<div id="main">
  ...
  <header id="topbar">
    <div class="tb-left">
      ...
      <div class="tb-bc">
        <a href="{{ route('mahasiswa.dashboard') }}" class="tb-home">LabFarma</a>
    ...
    <div class="user-wrap">
      ...
      <div class="user-dd" id="userDd">
        <div class="dd-head">
          ...
          <div class="dd-head-role">Mahasiswa · Aktif</div>
        </div>
  ...
  {{-- Tombol Scan QR Floating (Mobile only) --}}
  <a href="{{ route('mahasiswa.scan.qr') }}" class="fab-qr">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
